...
import { getEndElement, throttle, addEventListener, removeEventListener, } from '../utils/util';
...
export default Behavior({
    ...
    observers: {
        ...
        'renderedHistoryGroups.**,renderedNextGroups.**'(renderedHistoryGroups, renderedNextGroups) {
